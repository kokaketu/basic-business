...
var webpackConfig = merge(baseWebpackConfig, {
  ...
  output: {
    ...
    filename: utils.assetsPath('js/[name].js?v=' + packageConfig.version),
    chunkFilename: utils.assetsPath('js/[id].js?v=' + packageConfig.version)
  },
  ...
  new ExtractTextPlugin({
    filename: utils.assetsPath('css/[name].css?v=' + packageConfig.version),
