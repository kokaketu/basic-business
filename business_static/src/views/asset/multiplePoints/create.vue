<!--
 * @Author: your name
 * @Date: 2020-08-26 14:22:00
 * @LastEditTime: 2020-09-04 09:31:54
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \asset_management_static\src\views\asset\multiplePoints\create.vue
-->
<template>
  <div id="multiplePoints-create">
    <!-- 基本信息 -->
    <div class="base-info">
    ...
    <div class="btn-group">
      <el-button class="btn pull-right" @click.native="add">保存</el-button>
      <el-button class="btn btn-default pull-right" style="margin-right: 10px" @click.native="cancel">取消</el-button>
    </div>
  </div>
</template>
<script>
import { diverseAdd, getBuildingNameList, getFloorNameList, getRoomNo } from '@/http/assets'
...
<style lang="scss">
#multiplePoints-create .left-wrapper .el-form-item__label{
  text-align: right;
}
#multiplePoints-create .input-unit .el-input__inner{
  padding-right: 30px;
}
#multiplePoints-create .el-input-group__append{
  position: absolute;
  z-index: 999;
  top: 0;
  right: 0px;
