 ...
 * @LastEditTime: 2020-10-27 16:35:04
...
<template>
  <div id="project-create">
        ...
        <div class="filter-wrapper left-wrapper remove-style">
          <el-form
            ...
            <el-form-item label="项目编号" prop="assetCode">
              <el-input v-model="baseInfo.assetCode" placeholder="请输入项目编号"></el-input>
            </el-form-item>
            ...
            <br/>
            <el-form-item label="所在区域" required prop='cityNames'>
              <city-select
                :v-model="baseInfo.cityNames"
                style="width: 280px;"
            ...
            <el-form-item label="项目封面">
              ...
              <el-upload style="width:800px !important"
                action="''"
    ...
    <div class="corporate-information">
      ...
      <div class="new-block">
        <div class="filter-wrapper remove-style" style="width: 1200px">
          <el-row>
            <el-col :span="8">
...
<script>
import { assetAdd, setAssetCode, quotaLayoutCheck } from '@/http/assets'
...
export default {
  ...
  methods: {
    getAssetCode () {
      ...
      setAssetCode(params).then(res => {
        if (res.code === '0') {
          this.baseInfo.assetCode = res.data
        }
      })
    },
    cancel () {
    ...
    upDateCityFn (city) {
      ...
      this.baseInfo.cityNames = city.provinceName + city.cityName + city.districtName
    },
    ...
    add () {
      ...
      if (!this.baseInfo.city) return false
      ...
      assetAdd(params).then(res => {
        if (res.code === '0') {
          ...
          this.$router.push('/asset/project/detail/' + res.data)
        }
      })
    }
  },
...
<style lang="scss">
#project-create .left-wrapper .el-form-item__label{
  text-align: right;
}
#project-create .input-unit .el-input__inner{
  padding-right: 30px;
}
#project-create .el-input-group__append{
  position: absolute;
  z-index: 999;
  top: 0;
  right: 0px;
