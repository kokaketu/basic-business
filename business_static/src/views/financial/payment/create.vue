  ...
  <el-dialog :visible="visible" :close-on-click-modal="false" @close="close(false)">
    <el-card class="box-card">
      ...
      <el-form :model="form" :rules="rules" ref="form" label-width="120px">
        ...
        <el-row>
          <el-col :span="12">
            <project-auto-complete @select="selectProject" prop="assetId" :projectId="form.assetId" class="is-required" label="项目名称"/>
  ...
  methods: {
    ...
    selectSubject (subjectId) {
      ...
      this.subItemList.forEach((subItem, index) => {
        this.subItemList[index].subjectCode = selectedSubject.subjectCode
        this.subItemList[index].subjectName = selectedSubject.subjectName
      })
    },
