          ...
          <el-col :span="12">
            <el-form-item label="项目名称" prop="assetId">
              <el-select
                ...
                <el-option
                  v-for="{id, assetName} in projectNameList"
                  :key="id"
                  :label="assetName"
                  :value="id"></el-option>
              </el-select>
...
<script>
import { addAndReceivable } from '@/http/financial'
...
export default {
  ...
  components: { ProjectAutoComplete, PayerAutoComplete, InputNumber },
  props: {
    visible: {
      type: Boolean,
      default: false,
