    ...
    <el-card class="box-card">
      ...
      <el-form :model="form" :rules="rules" ref="form" label-width="120px">
        ...
        <div class="clearfix" style="margin-top: 20px">
          ...
          <el-button type="primary" @click="submit" class="fr" :disabled="!edit">保存</el-button>
        </div>
      </el-form>
    </el-card>
  </el-dialog>
...
<script>
import { addReceived, getReceivableList } from '@/http/financial'
...
export default {
  ...
  methods: {
    close (fresh) {
      ...
      this.form = { assetId: null, subjectId: null, companyId: null }
    ...
    add () {
      this.receivedDetailList = [...this.receivedDetailList, {taxRate: void 0, receivedMoney: void 0, receivables: []}]
    },
    del (index) {
