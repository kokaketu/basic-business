...
<script>
import { updContacts, queryContactsDetail } from '@/http/channel'
  ...
  methods: {
    ...
    getDetail () {
      queryContactsDetail({
        ...
        this.contactAgentList = res.contactAgentList.length > 0 ? res.contactAgentList : [{agentName: null, agentMobile: null}]
        this.contacts.contacts = res.contacts
        this.contacts.mobile = res.mobile
...
<style lang="scss">
#intermediary-edit .el-table td{
  padding: 0;
}
#intermediary-edit .el-table__body .el-input__inner:hover, .el-table__body .el-input__inner{
  border: none;
}
#intermediary-edit  .el-table--enable-row-hover .el-table__body tr:hover > td{
  background-color: unset;
}
#intermediary-edit .left-wrapper .el-form-item__label{
  text-align: right;
}
</style>
