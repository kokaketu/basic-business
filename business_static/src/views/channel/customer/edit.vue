    ...
    <div class="wrapper base-info">
      ...
      <div class="block">
        <el-form
          ...
          <el-form-item label="所在区域" prop="companyShortName">
        ...
        <el-form :inline="true" ref="ibClientNeeds" :model="ibClientNeeds" :rules="ibClientNeedsRules" size="small" label-width="120px">
          ...
          <el-form-item label="意向租赁单元" prop="needUnitIds">
            ...
            <el-dialog
              ...
              <el-select v-model="ibClientNeeds.buildingId" placeholder="请选择楼栋" style="width: 200px">
                <el-option
              ...
              <el-select v-model="ibClientNeeds.floorId" placeholder="请选择楼层" style="width: 200px">
                <el-option
              ...
              <el-select v-model="ibClientNeeds.needUnitIds" placeholder="请选择租赁单元" style="width: 200px">
                <el-option
          ...
          <el-form-item label="备注" prop="remark">
            <el-input type='textarea' style='width:775px' v-model="ibClientNeeds.remark" placeholder="请输入"></el-input>
          </el-form-item>
        </el-form>
      </div>
    </div>
...
import { getDetail, updateCustomer } from '@/http/rentControl'
...
#customer-edit .wrapper .el-input,
#customer-edit .wrapper .el-textarea,
#customer-edit .wrapper .el-select{
  width: 320px;
}
#customer-edit .el-table td{
  padding: 0;
}
#customer-edit .el-table .el-input,
#customer-edit .el-table .el-select{
  width: 100%;
  border: none;
}
</style>
<style lang="scss">
#customer-edit .table-input td {
  padding: 0;
  padding: 3px 0;
}
#customer-edit .table-input th {
  height: 46px;
  padding: 0;
  background:rgba(251,251,251,1);
  color: #808080;
}
#customer-edit .input-range .el-input{
...
#customer-edit .el-dialog .el-form-item__label {
...
#customer-edit .el-dialog .el-input,
#customer-edit .el-dialog .el-select,
#customer-edit .el-dialog .el-textarea,
#customer-edit .el-dialog .el-input,
#customer-edit .el-dialog .el-input__inner{
