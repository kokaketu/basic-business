 ...
 * @LastEditTime: 2020-10-09 11:15:56
...
export default {
  ...
  methods: {
    ...
    changeDate (reportId) {
      ...
      this.url = isDev
        ? `http://test-asset.caicchina.com/park-pdf/index.html?projectId=${projectId}&year=${year}&quarter=${quarter}&layout=${layout}&env=test`
        : `https://asset.caicchina.com/park-pdf/index.html?projectId=${projectId}&year=${year}&quarter=${quarter}&layout=${layout}&env=product`
    },
    reportDateList () {
