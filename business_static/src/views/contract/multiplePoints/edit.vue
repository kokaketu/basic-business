<!--
 * @Author: your name
 * @Date: 2020-08-24 15:41:14
 * @LastEditTime: 2020-09-01 15:14:53
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \asset_management_static\src\views\contract\multiplePoints\edit.vue
-->
<template>
...
export default {
  ...
  methods: {
    ...
    upDateLeaseArea () {
      ...
      this.lease.map(item => {
        if (item.key === 'rentArea') {
          const arr = this.baseInfo.unitList.map(item => Number(item.rentArea))
