package com.kokaketu.business.common.service.impl;
...
import com.kokaketu.business.common.constant.Constant;
import com.kokaketu.business.common.page.PageData;
import com.kokaketu.business.common.service.BaseService;
import com.kokaketu.business.common.utils.ConvertUtils;
...
public abstract class BaseServiceImpl<M extends BaseMapper<T>, T> implements BaseService<T> {
    ...
    protected IPage<T> getPage(Map<String, Object> params, String defaultOrderField, boolean isAsc) {
        ...
        //默认排序
        if (org.apache.commons.lang3.StringUtils.isNotEmpty(defaultOrderField)) {
            if (isAsc) {
